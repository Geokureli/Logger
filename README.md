...
class Main
{
    ...
    static public function main():Void
    {
        ...
        log.info("test log"); // Output: Special[INFO]: test log
        ...
        // set custom logger
        Logger.globalLog = (msg, ?pos) -> haxe.Log.trace('CUSTOM_$msg', pos);
        log.error.throws = false;
        log.error("test log"); // Output: CUSTOM_Special[ERROR]: test log
    }
}
```
